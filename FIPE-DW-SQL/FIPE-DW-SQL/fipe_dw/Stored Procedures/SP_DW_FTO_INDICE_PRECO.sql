-- [fipe_dw].[SP_DW_FTO_INDICE_PRECO] @FLG_REPROCESSAMENTO = 1
...
BEGIN 
	...
	CREATE CLUSTERED INDEX IXC_DW_FTO_INDICE_PRECO ON #DW_FTO_INDICE_PRECO (COD_MES_REFERENCIA, COD_INDICADOR,	COD_INDICADOR_ITEM)
	...
	MERGE INTO fipe_dw.DW_FTO_INDICE_PRECO WITH (TABLOCK) AS DESTINO
		USING (													
			...
			WHERE COD_MES_REFERENCIA = @COD_MES_REFERENCIA OR @COD_MES_REFERENCIA  IS NULL
