CREATE TABLE [fipe_dw].[DW_FTO_CRIME_VEICULO] (
    ...
    CONSTRAINT [FK_FTO_CRIME_TEMPO_MENSAL] FOREIGN KEY ([DTA_REFERENCIA]) REFERENCES [fipe_dw].[DW_DIM_TEMPO_MENSAL] ([COD_ANO_MES])
);
...
CREATE CLUSTERED INDEX [IXC_DW_FTO_CRIME_VEICULO]
    ON [fipe_dw].[DW_FTO_CRIME_VEICULO]([COD_UF] ASC, [DTA_REFERENCIA] ASC);
