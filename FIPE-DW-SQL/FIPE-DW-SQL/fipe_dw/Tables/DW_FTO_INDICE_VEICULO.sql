CREATE TABLE [fipe_dw].[DW_FTO_INDICE_VEICULO] (
    ...
    [DTA_REFERENCIA]              AS            (CONVERT([date],CONVERT([varchar](8),concat(COD_ANO_MES,'01')))),
    CONSTRAINT [PK_DW_FTO_INDICE_VEICULO] PRIMARY KEY CLUSTERED (COD_ANO_MES ASC, [COD_TIPO_VEICULO] ASC),
    CONSTRAINT [FK_DW_FTO_INDICE_VEICULO_TEMPO_MENSAL] FOREIGN KEY (COD_ANO_MES) REFERENCES [fipe_dw].[DW_DIM_TEMPO_MENSAL] (COD_ANO_MES)
);
