CREATE TABLE [fipe_dw].[DW_FTO_DADOS_MODELO] (
    ...
    CONSTRAINT [FK_DW_FTO_DADOS_MODELO_TEMPO_MENSAL] FOREIGN KEY ([DTA_REFERENCIA]) REFERENCES [fipe_dw].[DW_DIM_TEMPO_MENSAL_old] ([COD_MES_REFERENCIA]),
...
CREATE CLUSTERED INDEX [IXC_DW_FTO_DADOS_MODELO]
    ON [fipe_dw].[DW_FTO_DADOS_MODELO]([DTA_REFERENCIA] ASC, [COD_MODELO] ASC, [NUM_ANO_MODELO] ASC);
