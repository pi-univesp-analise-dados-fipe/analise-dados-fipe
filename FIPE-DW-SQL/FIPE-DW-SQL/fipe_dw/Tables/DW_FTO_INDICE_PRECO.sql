CREATE TABLE [fipe_dw].[DW_FTO_INDICE_PRECO] (
    ...
    CONSTRAINT [PK_DW_FTO_INDICE_PRECO] PRIMARY KEY CLUSTERED ([COD_MES_REFERENCIA] ASC, [COD_INDICADOR] ASC, [COD_INDICADOR_ITEM] ASC),
    ...
    CONSTRAINT [FK_INDICE_PRECO_TEMPO] FOREIGN KEY ([COD_MES_REFERENCIA]) REFERENCES [fipe_dw].[DW_DIM_TEMPO_MENSAL] ([COD_MES_REFERENCIA])
);
